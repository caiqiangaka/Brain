...
UINT16  crc16(UINT8 * frame, UINT16 len )
{
    UINT8 		ucCRCHi = 0xFF;
    UINT8 		ucCRCLo = 0xFF;
    UINT32 	iIndex;
...
//
////////////////////////////////////////////////////////////////////////////////
LOCAL UINT16 const CRC16Table[256] = {   
...
*******************************************************************************/
//UINT16  crc16(UINT8 * frame, UINT16 len )
UINT16 crc16(UINT8* dataIn, int length)
{  
    UINT16 result  = 0;
    UINT16 tableNo = 0;
    int i=0;
